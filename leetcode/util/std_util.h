...
public:
    ...
    */
    ...
    static std::vector<std::vector<std::string>> generateStringVectorMatrix(std::initializer_list<const char*>& input) {
        return generateVectorMatrix<std::string, StringTypeConverter>(input);
    }
